  ...
  return (
    <div className="w-full max-w-7xl mx-auto space-y-6">
      ...
      <div className="text-center">
        <h1 className="text-3xl font-bold font-headline mb-2">Multi-Planet Biology Comparator</h1>
        <p className="text-muted-foreground">Compare biological adaptations across Earth, Moon, and Mars</p>
      </div>
        ...
        {Object.entries(planetConfigs).map(([key, planet]) => (
          ...
          >
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                <div className="text-xl font-bold text-foreground">{planet.name}</div>
            ...
            <div className="grid grid-cols-2 gap-2 text-sm">
              ...
              <div className="text-foreground">{planet.gravity}g</div>
              <div className="text-muted-foreground">Temp:</div>
              <div className="text-foreground">{planet.temperature}°C</div>
              <div className="text-muted-foreground">Pressure:</div>
              <div className="text-foreground">{planet.pressure} kPa</div>
              <div className="text-muted-foreground">Radiation:</div>
              <div className="text-foreground">{planet.radiation} mSv/day</div>
            </div>
          </button>
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-card rounded-lg p-6 border">
          <h2 className="text-xl font-bold font-headline mb-4">Environmental Parameters</h2>
      ...
      <div className="bg-card rounded-lg p-6 border">
        <h2 className="text-xl font-bold font-headline mb-6">Three-Planet Comparison</h2>
        
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-border">
                <th className="text-left py-3 text-muted-foreground">Biological Metric</th>
                {Object.entries(planetConfigs).map(([key, planet]) => (
            ...
            <tbody>
              {[
                ...
                <tr key={rowIndex} className="border-b border-border last:border-none">
                  <td className="py-3 text-muted-foreground font-medium">{metric.label}</td>
      ...
      {/* Adaptation Timeline */}
      <div className="bg-card rounded-lg p-6 border">
        <h2 className="text-xl font-bold font-headline mb-4">Biological Adaptation Timeline</h2>
        <div className="space-y-4">
          {Object.entries(planetConfigs).map(([key, planet]) => (
      ...
      <div className="text-center">
        <div className={`inline-flex items-center gap-2 px-4 py-2 rounded-full ${
          isSimulating ? 'bg-green-900/50 text-green-300' : 'bg-muted text-muted-foreground'
        }`}>
